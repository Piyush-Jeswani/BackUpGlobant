(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('uptComparisonWidget', uptComparisonWidget);

  function uptComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/upt-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        zoneIds:                '=',
