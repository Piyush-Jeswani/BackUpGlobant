(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('laborHoursComparisonWidget', laborHoursComparisonWidget);

  function laborHoursComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/labor-hours-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        zoneIds:                '=',
