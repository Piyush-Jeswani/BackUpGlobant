(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('trafficComparisonWidget', trafficComparisonWidget);

  function trafficComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/traffic-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        locationIds:            '=',
