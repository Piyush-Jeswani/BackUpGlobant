(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('grossShoppingHoursComparisonWidget', grossShoppingHoursComparisonWidget);

  function grossShoppingHoursComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/gross-shopping-hours-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        locationIds:            '=',
