(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('drawRateComparisonWidget', drawRateComparisonWidget);

  function drawRateComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/draw-rate-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        locationIds:            '=',
