(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('starComparisonWidget', starComparisonWidget);

  function starComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/star-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        zoneIds:                '=',
