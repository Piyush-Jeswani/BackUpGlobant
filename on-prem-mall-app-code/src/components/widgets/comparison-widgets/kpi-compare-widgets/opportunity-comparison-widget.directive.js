(function() {
  ...
  angular.module('shopperTrak.widgets')
    .directive('opportunityComparisonWidget', opportunityComparisonWidget);

  function opportunityComparisonWidget() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: 'components/widgets/comparison-widgets/kpi-compare-widgets/opportunity-comparison-widget.partial.html',
      scope: {
        orgId:                  '=',
        siteId:                 '=',
        locationIds:            '=',
