...
angular.module('shopperTrak.widgets').directive('conversionSummaryWidget', function() {
  return {
    templateUrl: 'components/widgets/summary-widgets/conversion-summary-widget/conversion-summary-widget.partial.html',
    scope: {
      orgId:          '=orgId',
      siteId:         '=siteId',
