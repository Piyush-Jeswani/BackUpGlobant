...
angular.module('shopperTrak.widgets').directive('salesSummaryWidget', function() {
  return {
    templateUrl: 'components/widgets/summary-widgets/sales-summary-widget/sales-summary-widget.partial.html',
    scope: {
      orgId:          '=orgId',
      siteId:         '=siteId',
