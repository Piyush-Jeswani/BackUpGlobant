...
angular.module('shopperTrak.widgets').directive('starSummaryWidget', function() {
  return {
    templateUrl: 'components/widgets/summary-widgets/star-summary-widget/star-summary-widget.partial.html',
    scope: {
      orgId:          '=orgId',
      siteId:         '=siteId',
