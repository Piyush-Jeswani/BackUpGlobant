...
angular.module('shopperTrak.widgets').directive('dwellTimeSummaryWidget', function() {
  return {
    templateUrl: 'components/widgets/summary-widgets/dwell-time-summary-widget/dwell-time-summary-widget.partial.html',
    scope: {
      orgId:          '=orgId',
      siteId:         '=siteId',
