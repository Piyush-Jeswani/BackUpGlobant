...
module.exports = {
  widgetTag: 'visits-before-heatmap-widget',
  ...
  clickExportButton: function() {
    var exportButton = element(by.tagName('visits-before-heatmap-widget')).element(by.className('export-widget')).element(by.css('a'));
    exportButton.click();
  },
