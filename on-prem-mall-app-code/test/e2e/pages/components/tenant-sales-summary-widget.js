const tagName = 'tenant-sales-table-widget';
...
module.exports = {
  columnHeadings: ['Selected period sales', 'Change', 'Prior period sales', 'Change', 'Prior year sales'],
  ...
  getCurrentPeriodColumn() {
    return tableWidget.formatNumberArray(this.getColumnText('::item.periodValues[0].value '));
  },
