...
module.exports = {
  widgetTag: 'visits-after-heatmap-widget',
  ...
  clickExportButton: function() {
    var exportButton = element(by.tagName('visits-after-heatmap-widget')).element(by.className('export-widget')).element(by.css('a'));
    exportButton.click();
  },
