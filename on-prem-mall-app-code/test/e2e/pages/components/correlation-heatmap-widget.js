...
module.exports = {
  widgetTag: 'traffic-correlation-heatmap-widget',
  ...
  clickExportButton: function() {
    var exportButton = element(by.tagName('traffic-correlation-heatmap-widget')).element(by.className('export-widget')).element(by.css('a'));
    exportButton.click();
  },
  ...
  getPercentageFrameHeaderText: function() {
    return heatmapWidget.getPercentageFrameHeaderText(this.widgetTag);
  }
};
