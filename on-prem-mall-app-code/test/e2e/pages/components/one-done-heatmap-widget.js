...
module.exports = {
  widgetTag: 'one-and-done-heatmap-widget',
  ...
  clickExportButton: function() {
    var exportButton = element(by.tagName('one-and-done-heatmap-widget')).element(by.className('export-widget')).element(by.css('a'));
    exportButton.click();
  },
