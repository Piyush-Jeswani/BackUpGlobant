const exportPDFSharedLangTests = require('../../shared-specs/export-pdf-shared-translations.spec');
...
describe('Export PDF tab (translation tests)', () => {
  beforeAll(done => {
  ...
  describe('when user\'s language is Mexican Spanish', () => {
    exportPDFSharedLangTests.exportPDFSharedLangTests(locale);
  });
